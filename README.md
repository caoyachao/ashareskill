...
- **自动会话恢复**：智能检测BaoStock登录状态，自动重连

### 📝 更新日志

#### v1.0.2 (2026-03-19) - 稳定性修复版

**修复内容：**
- ✅ 修复BaoStock会话过期导致的查询失败问题
- ✅ 新增 `_ensure_login()` 方法，自动检测并重连
- ✅ 新增 `_query_kline_with_retry()` 方法，支持3次重试
- ✅ 修复指数成分股查询返回空列表问题
- ✅ 修复批量查询时的会话中断问题
- ✅ 添加高频查询稳定性优化
